...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const articleTmpl = document.querySelector(".articles__item-tmpl")
    .firstElementChild;
      ...
      .then((data) => {
        ...
        if (statusCode == 200 && Array.isArray(data)) {
          ...
          data.forEach((article) => {
            ...
            frag.querySelector(".articles__item-date").textContent = article.created; //年-月-日のみを抽出
